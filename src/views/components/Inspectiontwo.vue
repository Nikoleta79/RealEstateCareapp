...
<template>
  ...
  >
        ...
        >
          <div style="text-align: left;">
            ...
            <span
                ...
                borderRadius: '5px',
                color: '#fff',
                backgroundColor: inspectionStatus === 'completed' ? '#28a745' : '#dc3545',
                marginRight: '10px',
                fontSize: '1rem',
                fontWeight: 'bold',
                border: '1px solid #ccc',
    ...
    <p v-else class="mt-4 text-center">The scheduled inspections have been completed and they are not available at the moment.</p>
  </main>
</template>
...
//  status to "completed"
const inspectionStatus = ref("completed");
