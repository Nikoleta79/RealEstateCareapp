    ...
    <ion-list>
      ...
      <div class="navigation-buttons ">
        <ion-button
            ...
            :class="{ 'text-dark': !themeStore.darkMode, 'text-light': themeStore.darkMode }"
        >
          <ion-icon :icon="arrowBack" slot="start" :class="{ 'text-dark': !themeStore.darkMode, 'text-light': themeStore.darkMode }"></ion-icon>
          Go Back
        </ion-button>
...
import { moon, sunny, arrowBack, logOutOutline, eyeOutline, eyeOffOutline } from 'ionicons/icons';
import { ref } from 'vue';
