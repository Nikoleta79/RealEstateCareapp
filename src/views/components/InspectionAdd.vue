          ...
          <form aria-label="Form to edit inspection" class="w-100">
            ...
            <div class="form-group my-3">
              <div class="form-group my-3 d-flex align-items-center">
                ...
                >
                  <ion-icon
                      :icon="showDamageForm ? 'chevron-up-outline' : 'chevron-down-outline'"
                      size="small"
                      class="text-white"
                  ></ion-icon>
                </button>
            ...
            <div class="form-group my-3">
              <div class="form-group my-3 d-flex align-items-center">
                ...
                >
                  <ion-icon
                      :icon="showMaintenanceForm ? 'chevron-up-outline' : 'chevron-down-outline'"
                      size="small"
                      class="text-white"
                  ></ion-icon>
                </button>
            ...
            <div class="form-group my-3">
              <div class="form-group my-3 d-flex align-items-center">
                ...
                >
                  <ion-icon
                      :icon="showInstallationsForm ? 'chevron-up-outline' : 'chevron-down-outline'"
                      size="small"
                      class="text-white"
                  ></ion-icon>
                </button>
            ...
            <div class="form-group my-3">
              <div class="form-group my-3 d-flex align-items-center">
                ...
                >
                  <ion-icon
                      :icon="showModificationsForm ? 'chevron-up-outline' : 'chevron-down-outline'"
                      size="small"
                      class="text-white"
                  ></ion-icon>
                </button>
...
.form-container {
  height: calc(100vh - 220px); /* Adjusted height to move buttons up by 2 cm */
  padding: 1.5rem;
  overflow-y: auto;
  width: 90%; /* Make the form container take 90% of the width */
