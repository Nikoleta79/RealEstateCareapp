...
<script>
    ...
    import DamageComponent from './components/template/DaComp.vue';
    import MaintenanceComponent from './components/template/MainComp.vue';
    import InstallationComponent from './components/template/InsComp.vue';
    import ModificationComponent from './components/template/ModComp.vue';
