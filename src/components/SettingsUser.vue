      ...
      <ion-item-group>
        ...
        <ion-item>
          ...
          <ion-toggle v-model="sounds" slot="end"></ion-toggle>
              ...
              <!-- Language Selection -->
        <ion-item>
          <ion-label :class="{ 'text-dark': !themeStore.darkMode, 'text-light': themeStore.darkMode }">Language</ion-label>
          <ion-select v-model="language" @ionChange="changeLanguage" slot="end">
            <ion-select-option value="en">English</ion-select-option>
            <ion-select-option value="fr">Nederlands</ion-select-option>                       
          </ion-select>
        </ion-item>
...
const language = computed({
  ...
  set: (newLang) => settingsStore.setLanguage(newLang)
});
...
const changeLanguage = (event) => {
  settingsStore.setLanguage(event.detail.value);
}; 
